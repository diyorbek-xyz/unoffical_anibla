...
class AnimeModelAdapter extends TypeAdapter<AnimeModel> {
  ...
  AnimeModel read(BinaryReader reader) {
    ...
    return AnimeModel(
      ...
      categories: (fields[15] as List?)?.cast<CategoryModel>(),
      country: fields[10] as CountryModel?,
      creators: (fields[13] as List?)?.cast<AccountModel>(),
      director: fields[12] as AccountModel?,
      genres: (fields[14] as List?)?.cast<GenreModel>(),
      studio: fields[11] as AccountModel?,

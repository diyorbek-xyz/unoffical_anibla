...
class _FilterApi implements FilterApi {
  _FilterApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<ApiResponse<List<AnimeModel>>>> searchAnime(
    ...
    final _options = _setStreamType<HttpResponse<ApiResponse<List<AnimeModel>>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/${type}/mobile?search=${search}&category=${category}&genres=${genre}',

...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( GetNotifications value)?  get,required TResult orElse(),}){
final _that = this;
switch (_that) {
case GetNotifications() when get != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( GetNotifications value)  get,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( GetNotifications value)?  get,}){
final _that = this;
switch (_that) {
case GetNotifications() when get != null:
return get(_that);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetNotifications);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( NotificationResponseEntity response)?  success,TResult Function( String message)?  failed,TResult Function()?  initial,TResult Function()?  loading,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( NotificationResponseEntity response)  success,required TResult Function( String message)  failed,required TResult Function()  initial,required TResult Function()  loading,}) {final _that = this;
switch (_that) {
case _Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( NotificationResponseEntity response)?  success,TResult? Function( String message)?  failed,TResult? Function()?  initial,TResult? Function()?  loading,}) {final _that = this;
switch (_that) {
case _Success() when success != null:
return success(_that.response);case _Failed() when failed != null:
return failed(_that.message);case _Initial() when initial != null:
...
class _Success implements NotificationState {
 ...
 final  NotificationResponseEntity response;
...
@override
String toString() {
  return 'NotificationState.success(response: $response)';
}
...
@useResult
$Res call({
 NotificationResponseEntity response
});
...
class _Failed implements NotificationState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $NotificationStateCopyWith<$Res> {
